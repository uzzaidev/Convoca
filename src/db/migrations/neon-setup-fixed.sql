...
-- PARTE 1: DROPAR TABELAS EXISTENTES (SE HOUVER)
-- ============================================================================

DROP MATERIALIZED VIEW IF EXISTS mv_event_scoreboard CASCADE;
DROP TRIGGER IF EXISTS trigger_refresh_scoreboard ON event_actions;
DROP FUNCTION IF EXISTS refresh_event_scoreboard() CASCADE;
...
CREATE INDEX idx_player_ratings_event ON player_ratings(event_id);
...
INSERT INTO venues (id, group_id, name, address, created_at) VALUES
  ('aaaabbbb-1111-1111-1111-111111111111', 'aaaabbbb-cccc-dddd-eeee-111111111111', 'Campo do Parque da Cidade', 'Av. Principal, 1000', NOW() - INTERVAL '90 days'),
  ('bbbbbbbb-2222-2222-2222-222222222222', 'aaaabbbb-cccc-dddd-eeee-111111111111', 'Society Vila Nova', 'Rua das Flores, 500', NOW() - INTERVAL '85 days');

-- Eventos passados
INSERT INTO events (id, group_id, starts_at, venue_id, max_players, max_goalkeepers, status, created_by, created_at) VALUES
  ('e1111111-1111-1111-1111-111111111111', 'aaaabbbb-cccc-dddd-eeee-111111111111', NOW() - INTERVAL '14 days', 'aaaabbbb-1111-1111-1111-111111111111', 10, 2, 'finished', '11111111-1111-1111-1111-111111111111', NOW() - INTERVAL '21 days'),
  ('e2222222-2222-2222-2222-222222222222', 'aaaabbbb-cccc-dddd-eeee-111111111111', NOW() - INTERVAL '7 days', 'aaaabbbb-1111-1111-1111-111111111111', 10, 2, 'finished', '11111111-1111-1111-1111-111111111111', NOW() - INTERVAL '14 days');

-- Eventos futuros
INSERT INTO events (id, group_id, starts_at, venue_id, max_players, max_goalkeepers, status, created_by, created_at) VALUES
  ('eeeeee11-1111-1111-1111-111111111111', 'aaaabbbb-cccc-dddd-eeee-111111111111', NOW() + INTERVAL '6 days', 'aaaabbbb-1111-1111-1111-111111111111', 10, 2, 'scheduled', '11111111-1111-1111-1111-111111111111', NOW() - INTERVAL '2 days'),
  ('eeeeee22-2222-2222-2222-222222222222', 'aaaabbbb-cccc-dddd-eeee-111111111111', NOW() + INTERVAL '13 days', 'bbbbbbbb-2222-2222-2222-222222222222', 10, 2, 'scheduled', '11111111-1111-1111-1111-111111111111', NOW() - INTERVAL '1 day');

-- Attendance
INSERT INTO event_attendance (event_id, user_id, role, status, checked_in_at, order_of_arrival) VALUES
  ('e1111111-1111-1111-1111-111111111111', '11111111-1111-1111-1111-111111111111', 'line', 'yes', NOW() - INTERVAL '14 days', 1),
  ('e1111111-1111-1111-1111-111111111111', '22222222-2222-2222-2222-222222222222', 'gk', 'yes', NOW() - INTERVAL '14 days', 2),
  ('e1111111-1111-1111-1111-111111111111', '33333333-3333-3333-3333-333333333333', 'line', 'yes', NOW() - INTERVAL '14 days', 3),
  ('e1111111-1111-1111-1111-111111111111', '44444444-4444-4444-4444-444444444444', 'line', 'yes', NOW() - INTERVAL '14 days', 4),
  ('e1111111-1111-1111-1111-111111111111', '55555555-5555-5555-5555-555555555555', 'line', 'yes', NOW() - INTERVAL '14 days', 5),
  ('e1111111-1111-1111-1111-111111111111', '66666666-6666-6666-6666-666666666666', 'line', 'yes', NOW() - INTERVAL '14 days', 6),
  ('e1111111-1111-1111-1111-111111111111', '77777777-7777-7777-7777-777777777777', 'line', 'yes', NOW() - INTERVAL '14 days', 7),
  ('e1111111-1111-1111-1111-111111111111', '88888888-8888-8888-8888-888888888888', 'line', 'yes', NOW() - INTERVAL '14 days', 8),
  ('e1111111-1111-1111-1111-111111111111', '99999999-9999-9999-9999-999999999999', 'line', 'yes', NOW() - INTERVAL '14 days', 9),
  ('e1111111-1111-1111-1111-111111111111', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'line', 'yes', NOW() - INTERVAL '14 days', 10);

INSERT INTO event_attendance (event_id, user_id, role, status) VALUES
  ('eeeeee11-1111-1111-1111-111111111111', '11111111-1111-1111-1111-111111111111', 'line', 'yes'),
  ('eeeeee11-1111-1111-1111-111111111111', '22222222-2222-2222-2222-222222222222', 'gk', 'yes'),
  ('eeeeee11-1111-1111-1111-111111111111', '33333333-3333-3333-3333-333333333333', 'line', 'yes'),
  ('eeeeee11-1111-1111-1111-111111111111', '44444444-4444-4444-4444-444444444444', 'line', 'yes'),
  ('eeeeee11-1111-1111-1111-111111111111', '55555555-5555-5555-5555-555555555555', 'line', 'yes'),
  ('eeeeee11-1111-1111-1111-111111111111', '66666666-6666-6666-6666-666666666666', 'line', 'yes'),
  ('eeeeee11-1111-1111-1111-111111111111', '77777777-7777-7777-7777-777777777777', 'line', 'yes'),
  ('eeeeee11-1111-1111-1111-111111111111', '88888888-8888-8888-8888-888888888888', 'line', 'yes'),
  ('eeeeee11-1111-1111-1111-111111111111', '99999999-9999-9999-9999-999999999999', 'line', 'waitlist'),
  ('eeeeee11-1111-1111-1111-111111111111', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'line', 'waitlist');

-- Times
INSERT INTO teams (id, event_id, name, seed, is_winner) VALUES
  ('aaaa1111-1111-1111-1111-111111111111', 'e1111111-1111-1111-1111-111111111111', 'Time A', 1, true),
  ('bbbb1111-1111-1111-1111-111111111111', 'e1111111-1111-1111-1111-111111111111', 'Time B', 2, false);

INSERT INTO team_members (team_id, user_id, position) VALUES
  ('aaaa1111-1111-1111-1111-111111111111', '22222222-2222-2222-2222-222222222222', 'gk'),
  ('aaaa1111-1111-1111-1111-111111111111', '11111111-1111-1111-1111-111111111111', 'line'),
  ('aaaa1111-1111-1111-1111-111111111111', '44444444-4444-4444-4444-444444444444', 'line'),
  ('aaaa1111-1111-1111-1111-111111111111', '55555555-5555-5555-5555-555555555555', 'line'),
  ('aaaa1111-1111-1111-1111-111111111111', '77777777-7777-7777-7777-777777777777', 'line'),
  ('bbbb1111-1111-1111-1111-111111111111', '33333333-3333-3333-3333-333333333333', 'line'),
  ('bbbb1111-1111-1111-1111-111111111111', '66666666-6666-6666-6666-666666666666', 'line'),
  ('bbbb1111-1111-1111-1111-111111111111', '88888888-8888-8888-8888-888888888888', 'line'),
  ('bbbb1111-1111-1111-1111-111111111111', '99999999-9999-9999-9999-999999999999', 'line'),
  ('bbbb1111-1111-1111-1111-111111111111', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'line');

-- Ações (Time A 4 x 2 Time B)
INSERT INTO event_actions (event_id, actor_user_id, action_type, subject_user_id, team_id, minute) VALUES
  ('e1111111-1111-1111-1111-111111111111', '44444444-4444-4444-4444-444444444444', 'goal', NULL, 'aaaa1111-1111-1111-1111-111111111111', 5),
  ('e1111111-1111-1111-1111-111111111111', '11111111-1111-1111-1111-111111111111', 'assist', '44444444-4444-4444-4444-444444444444', 'aaaa1111-1111-1111-1111-111111111111', 5),
  ('e1111111-1111-1111-1111-111111111111', '55555555-5555-5555-5555-555555555555', 'goal', NULL, 'aaaa1111-1111-1111-1111-111111111111', 12),
  ('e1111111-1111-1111-1111-111111111111', '77777777-7777-7777-7777-777777777777', 'goal', NULL, 'aaaa1111-1111-1111-1111-111111111111', 23),
  ('e1111111-1111-1111-1111-111111111111', '44444444-4444-4444-4444-444444444444', 'assist', '77777777-7777-7777-7777-777777777777', 'aaaa1111-1111-1111-1111-111111111111', 23),
  ('e1111111-1111-1111-1111-111111111111', '44444444-4444-4444-4444-444444444444', 'goal', NULL, 'aaaa1111-1111-1111-1111-111111111111', 38),
  ('e1111111-1111-1111-1111-111111111111', '99999999-9999-9999-9999-999999999999', 'goal', NULL, 'bbbb1111-1111-1111-1111-111111111111', 18),
  ('e1111111-1111-1111-1111-111111111111', '88888888-8888-8888-8888-888888888888', 'assist', '99999999-9999-9999-9999-999999999999', 'bbbb1111-1111-1111-1111-111111111111', 18),
  ('e1111111-1111-1111-1111-111111111111', '88888888-8888-8888-8888-888888888888', 'goal', NULL, 'bbbb1111-1111-1111-1111-111111111111', 35),
  ('e1111111-1111-1111-1111-111111111111', '22222222-2222-2222-2222-222222222222', 'save', NULL, 'aaaa1111-1111-1111-1111-111111111111', 15),
  ('e1111111-1111-1111-1111-111111111111', '22222222-2222-2222-2222-222222222222', 'save', NULL, 'aaaa1111-1111-1111-1111-111111111111', 28);

-- Avaliações
INSERT INTO player_ratings (event_id, rater_user_id, rated_user_id, score, tags) VALUES
  ('e1111111-1111-1111-1111-111111111111', '11111111-1111-1111-1111-111111111111', '44444444-4444-4444-4444-444444444444', 9, ARRAY['mvp', 'artilheiro']),
  ('e1111111-1111-1111-1111-111111111111', '11111111-1111-1111-1111-111111111111', '22222222-2222-2222-2222-222222222222', 8, ARRAY['paredao']),
  ('e1111111-1111-1111-1111-111111111111', '22222222-2222-2222-2222-222222222222', '44444444-4444-4444-4444-444444444444', 9, ARRAY['mvp']),
  ('e1111111-1111-1111-1111-111111111111', '22222222-2222-2222-2222-222222222222', '77777777-7777-7777-7777-777777777777', 8, ARRAY['garcom']);
...
-- ============================================================================
-- PRONTO! Login: carlos@test.com | Senha: senha123
-- ============================================================================
