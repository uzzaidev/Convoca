...
--
-- ATENÇÃO: Este script vai DELETAR todos os dados existentes!
-- Use apenas em ambiente de desenvolvimento/teste
-- ============================================================================

-- Tentar habilitar UUID extension (pode já estar habilitada no Neon)
-- Se der erro, ignore - o Neon geralmente já tem essa extensão ativa
DO $$
BEGIN
...
-- ============================================================================
-- PARTE 2: LIMPAR DADOS EXISTENTES (SE HOUVER)
-- ============================================================================
...
-- Membros do Grupo 1: Pelada do Parque
...
-- Membros do Grupo 2: Futebol de Quinta
INSERT INTO group_members (user_id, group_id, role, is_goalkeeper, base_rating, joined_at) VALUES
...
-- Eventos passados (simplificando - apenas 3 eventos para o script não ficar muito longo)
...
-- Attendance para evento passado 1
...
-- Attendance para evento passado 2
INSERT INTO event_attendance (event_id, user_id, role, status, checked_in_at, order_of_arrival) VALUES
  ('event222-2222-2222-2222-222222222222', '11111111-1111-1111-1111-111111111111', 'line', 'yes', NOW() - INTERVAL '7 days', 1),
  ('event222-2222-2222-2222-222222222222', '22222222-2222-2222-2222-222222222222', 'gk', 'yes', NOW() - INTERVAL '7 days', 2),
  ('event222-2222-2222-2222-222222222222', '33333333-3333-3333-3333-333333333333', 'line', 'yes', NOW() - INTERVAL '7 days', 3),
  ('event222-2222-2222-2222-222222222222', '44444444-4444-4444-4444-444444444444', 'line', 'yes', NOW() - INTERVAL '7 days', 4),
  ('event222-2222-2222-2222-222222222222', '55555555-5555-5555-5555-555555555555', 'line', 'yes', NOW() - INTERVAL '7 days', 5),
  ('event222-2222-2222-2222-222222222222', '77777777-7777-7777-7777-777777777777', 'line', 'yes', NOW() - INTERVAL '7 days', 6),
  ('event222-2222-2222-2222-222222222222', '88888888-8888-8888-8888-888888888888', 'line', 'yes', NOW() - INTERVAL '7 days', 7),
  ('event222-2222-2222-2222-222222222222', '99999999-9999-9999-9999-999999999999', 'line', 'yes', NOW() - INTERVAL '7 days', 8),
  ('event222-2222-2222-2222-222222222222', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'line', 'yes', NOW() - INTERVAL '7 days', 9),
  ('event222-2222-2222-2222-222222222222', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 'gk', 'yes', NOW() - INTERVAL '7 days', 10);

-- RSVP para eventos futuros
...
-- Ações de jogo - Event 1: Time A 4 x 2 Time B
...
INSERT INTO wallets (owner_type, owner_id, balance_cents) VALUES
  ...
  ('user', '44444444-4444-4444-4444-444444444444', -2000);
...
UNION ALL
SELECT 'Membros', COUNT(*) FROM group_members
UNION ALL
...
-- PRONTO!
-- ============================================================================
-- Login: carlos@test.com (ou qualquer outro email acima)
-- Senha: senha123
-- ============================================================================
